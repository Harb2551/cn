...
set nt [open lab1.tr w] $ns trace-all $nt
...
$n0 label "Source/udp0" $n1 label "Source/udp1" $n2 label "Router"
...
set null3 [new Agent/Null] $ns attach-agent $n3 $null3
...
global ns nf nt
$ns flush-trace
exec nam lab1.nam & close $nt
close $nf
exit 0
}
$ns at 0.1 "$cbr0 start" $ns at 0.1 "$cbr1 start" $ns at 10.0 "finish" 
$ns run